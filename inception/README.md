...
- Wordpress Service: A WordPress service is set up to serve a website, 
- Database Service: A MySQL database service is configured to store data for the WordPress site.
